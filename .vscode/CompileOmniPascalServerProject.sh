...
PROJECT="/home/milhar/Documents/prog/compilers/dragon/compiler.lpi"
...
echo. >> "/home/milhar/Documents/prog/compilers/dragon/compiler.lpr"

if $LAZBUILD $PROJECT; then

  if [ $1 = "test" ]; then
    "/home/milhar/Documents/prog/compilers/dragon/compiler" 
  fi
fi
